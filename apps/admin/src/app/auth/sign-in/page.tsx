 ...
 export default function SignInPage() {
   ...
   return (
     <div className="min-h-screen bg-slate-50 px-6 py-12 dark:bg-gray-dark">
       <div className="mx-auto max-w-6xl">
         <div className="grid grid-cols-12 gap-8">
           <div className="hidden rounded-xl border bg-white p-8 shadow-sm dark:border-dark-4 dark:bg-dark-2 md:col-span-7 md:block">
             <div className="mb-6 flex items-center justify-between">
               <div className="text-xl font-bold text-indigo-600">Sofia Admin</div>
               <div className="text-sm text-dark-6 dark:text-dark-7">Dashboard</div>
             </div>
             <h2 className="mb-4 text-2xl font-semibold text-dark dark:text-white">Visão geral</h2>
             <p className="mb-6 text-sm text-dark-6 dark:text-dark-7">Painel rápido com métricas e atalhos para parceiros.</p>
             <div className="grid grid-cols-2 gap-4">
               <div className="rounded-xl border bg-white p-4 shadow-sm dark:border-dark-4 dark:bg-dark-2">
                 <div className="text-sm text-dark-6 dark:text-dark-7">Total Views</div>
                 <div className="text-2xl font-bold text-dark dark:text-white">3.5K</div>
                 <div className="text-xs text-green-600">+0.43%</div>
               </div>
               <div className="rounded-xl border bg-white p-4 shadow-sm dark:border-dark-4 dark:bg-dark-2">
                 <div className="text-sm text-dark-6 dark:text-dark-7">Total Profit</div>
                 <div className="text-2xl font-bold text-dark dark:text-white">$4.2K</div>
                 <div className="text-xs text-green-600">+4.35%</div>
               </div>
               <div className="rounded-xl border bg-white p-4 shadow-sm dark:border-dark-4 dark:bg-dark-2">
                 <div className="text-sm text-dark-6 dark:text-dark-7">Total Products</div>
                 <div className="text-2xl font-bold text-dark dark:text-white">3.5K</div>
                 <div className="text-xs text-green-600">+2.59%</div>
               </div>
               <div className="rounded-xl border bg-white p-4 shadow-sm dark:border-dark-4 dark:bg-dark-2">
                 <div className="text-sm text-dark-6 dark:text-dark-7">Total Users</div>
                 <div className="text-2xl font-bold text-dark dark:text-white">3.5K</div>
                 <div className="text-xs text-red-600">-0.95%</div>
               </div>
             </div>
           </div>
           <div className="col-span-12 rounded-xl border bg-white p-8 shadow-sm dark:border-dark-4 dark:bg-gray-dark md:col-span-5">
