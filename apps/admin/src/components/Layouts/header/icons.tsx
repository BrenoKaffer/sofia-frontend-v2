...
export function LinkIcon(props: IconProps) {
  return (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" {...props}>
      <path d="M3.9 12a5 5 0 015-5h3v2h-3a3 3 0 000 6h3v2h-3a5 5 0 01-5-5zm7-1h2v2h-2v-2zm4.1-4h-3V5h3a5 5 0 110 10h-3v-2h3a3 3 0 000-6z" />
    </svg>
  );
}
...
export function WalletIcon(props: IconProps) {
  return (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" {...props}>
      <path d="M21 7H5a2 2 0 00-2 2v10a3 3 0 003 3h15V7zm-1 9h-3a2 2 0 110-4h3v4z" />
      <path d="M20 5H6a3 3 0 00-3 3h2a1 1 0 011-1h14V5z" />
    </svg>
  );
}
...
export function ShoppingBagIcon(props: IconProps) {
  return (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" {...props}>
      <path d="M7 7V6a5 5 0 0110 0v1h4l-1.5 14A2 2 0 0117.5 23h-11A2 2 0 014.5 21L3 7h4zm2 0h6V6a3 3 0 00-6 0v1z" />
    </svg>
  );
}
...
export function UsersIcon(props: IconProps) {
  return (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" {...props}>
      <path d="M16 11a4 4 0 10-8 0 4 4 0 008 0zM2 20a6 6 0 0112 0v2H2v-2zm13.5 2V20a7.9 7.9 0 00-1.6-4.8A6 6 0 0122 20v2h-6.5z" />
    </svg>
  );
}
...
export function PercentIcon(props: IconProps) {
  return (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" {...props}>
      <path d="M7 21l14-18h-2L5 21h2zM7.5 9A2.5 2.5 0 105 6.5 2.5 2.5 0 007.5 9zm9 9A2.5 2.5 0 1014 15.5 2.5 2.5 0 0016.5 18z" />
    </svg>
  );
}
