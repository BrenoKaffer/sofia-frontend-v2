...
export function Component({ sizing = 'fill', color = 'rgba(128, 128, 128, 1)', animation, noise, style, className }: ShadowOverlayProps) {
            ...
            {noise && noise.opacity > 0 && (
                <div
                    style={{
                        ...
                        inset: 0,
                        backgroundImage:
                            "url('https://images.unsplash.com/photo-1527489377706-62b8041f9d09?auto=format&fit=crop&w=1200&q=60')",
