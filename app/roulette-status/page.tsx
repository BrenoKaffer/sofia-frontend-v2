...
// Função para gerar números aleatórios de roleta (0-36)
const generateRandomRouletteNumbers = (count: number) => {
...
const mockRoulettes = [
  {
    ...
    isSpinning: false,
    lastNumbers: [
      23, 7, 14, 31, 0, 18, 9, 26, 35, 3, 12, 28, 7, 21, 34, 16, 5, 29, 11, 2,
      15, 33, 8, 24, 1, 36, 13, 25, 4, 20, 9, 27, 12, 32, 6, 19, 30, 17, 22, 10,
      ...generateRandomRouletteNumbers(460) // Gera mais 460 números para totalizar 500
    ],
  ...
  },
  {
    ...
    isSpinning: true,
    lastNumbers: [
      15, 22, 8, 19, 33, 6, 24, 17, 1, 30, 13, 25, 4, 36, 20, 9, 27, 12, 32, 5,
      23, 7, 14, 31, 0, 18, 26, 35, 3, 28, 21, 34, 16, 29, 11, 2, 10, 25, 18, 7,
      ...generateRandomRouletteNumbers(460) // Gera mais 460 números para totalizar 500
    ],
  ...
  },
  {
    ...
    isSpinning: false,
    lastNumbers: [
      10, 25, 3, 18, 31, 7, 22, 14, 29, 6, 33, 11, 26, 2, 35, 19, 8, 23, 16, 4,
      15, 22, 19, 33, 24, 17, 1, 30, 13, 25, 36, 20, 9, 27, 12, 32, 5, 0, 18, 26,
      ...generateRandomRouletteNumbers(460) // Gera mais 460 números para totalizar 500
    ],
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                {selectedForComparison.map(rouletteId => {
                  const roulette = mockRoulettes.find(r => r.id === rouletteId)
                      ...
                      <CardContent>
                        <div className="space-y-4">
                          ...
                          <div>
                            ...
                            <div className="flex flex-wrap gap-1">
                              {roulette.lastNumbers.slice(0, 10).map((num, idx) => (
                                <Badge 
                                  key={idx} 
                                  variant="outline" 
                          ...
                          <div>
                            ...
                            <div className="flex flex-wrap gap-1">
                              {roulette.hotNumbers.map((num, idx) => (
                                <Badge 
                                  key={idx} 
                                  variant="destructive" 
                                  className="text-xs cursor-pointer transition-all duration-200"
                          ...
                          <div>
                            ...
                            <div className="flex flex-wrap gap-1">
                              {roulette.coldNumbers.map((num, idx) => (
                                <Badge 
                                  key={idx} 
                                  variant="secondary" 
                                  className="text-xs cursor-pointer transition-all duration-200"
