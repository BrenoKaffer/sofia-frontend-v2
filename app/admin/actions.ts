...
async function checkAdminPermission() {
  ...
  // Temporary: Hardcoded check for owner/admin
  // In future: Check user_profiles.role
  const allowedEmails = ['ferreiraoffice07@gmail.com'];
  
  if (!allowedEmails.includes(user.email || '')) {
      // Fallback: Check DB role if implemented
